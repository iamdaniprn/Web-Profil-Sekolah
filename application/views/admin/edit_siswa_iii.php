                ...
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <strong>Edit</strong> Siswa Kelas III
                      </div>
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/update_siswa_iii" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <input type="hidden" name="id_siswa" value="<?php echo $id_siswa ?>">
                            <input type="hidden" name="kelas" value="III">
                              <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="text-input" class=" form-control-label">NIS</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="nis" value="<?php echo $nis ?>" placeholder="nis" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="alamat" value="<?php echo $alamat ?>" placeholder="alamat" class="form-control">
                                </div>
                              </div>
                          </div>
