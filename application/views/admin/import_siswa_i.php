                ...
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <strong>Import</strong> Data Siswa Kelas I
                      </div>
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/upload_siswa_i" method="post" enctype="multipart/form-data" class="form-horizontal">

                              <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="file-input" class=" form-control-label">Masukkan File Excel</label>
                                </div>
                          ...
                          <div class="card-footer">
                            <button type="submit" class="btn btn-primary btn-sm" value="Upload file">
