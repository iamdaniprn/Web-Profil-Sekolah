                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Data Siswa Kelas I</strong>
                        </div>
                          ...
                          <table id_siswa="bootstrap-data-table" class="table table-striped table-bordered">
                            ...
                            ?>
                              <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>admin/edit_siswa_i/<?php echo $row['id_siswa']; ?>" data-toggle="tooltip" data-placement="top" title="EDIT">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/hapus_siswa_i/<?php echo $row['id_siswa']; ?>" data-toggle="tooltip" data-placement="top" title="HAPUS">
