                ...
                <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/update_artikel" method="post" enctype="multipart/form-data" class="form-horizontal">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" value="<?php echo $judul ?>" id="text-input" name="judul" placeholder="judul" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                               ...
                               <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="text-input" class=" form-control-label">Masukkan Lagi Gambar</label>
                                </div>
                                <div class="col-12 col-md-9">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="penulis" value="<?php echo $penulis ?>" placeholder="penulis" class="form-control">
                                </div>
                              </div>
