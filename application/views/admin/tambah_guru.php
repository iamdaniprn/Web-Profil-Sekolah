                ...
                <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/simpan_guru" method="post" enctype="multipart/form-data" class="form-horizontal">
                              <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="text-input" class=" form-control-label">NIP</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="nip" placeholder="nip" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="umur" placeholder="umur" class="form-control">
                                </div>
                              </div>
