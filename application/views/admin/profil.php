...
<head>
    ...
    <meta name="viewport" content="wid_profilth=device-wid_profilth, initial-scale=1">
...
<body>
    ...
    <div id_profil="right-panel" class="right-panel">
        <!-- Header-->
        <header id_profil="header" class="header">
            <div class="header-menu">
                <div class="col-sm-7">
                    <a id_profil="menuToggle" class="menutoggle pull-left"><i class="fa fa fa-tasks"></i></a>
                </div>
        ...
        <div class="content mt-12">
            <div class="animated fadeIn">
                <div class="row">
                <div class="col-md-12">
                    <a href="<?php echo base_url()?>admin/tambah_profil"><button class="btn btn-info">Tambah</button></a><br><br>
                </div>
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <table id_profil="bootstrap-data-table" class="table table-striped table-bordered">
                            <thead>
                              <tr>
                                <th>No</th>
                                <th>Judul</th>
                            ...
                            <tbody>
                            <?php $no = 0; foreach($data_profil as $row) 
                            { 
                                $no++;
                            ?>
                              <tr>
                                ...
                                <td>
                                     <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>admin/detail_profil/<?php echo $row['id_profil']; ?>" data-toggle="tooltip" data-placement="top" title="DETAIL">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                    <a class="btn btn-success btn-sm" href="<?php echo base_url(); ?>admin/edit_profil/<?php echo $row['id_profil']; ?>" data-toggle="tooltip" data-placement="top" title="EDIT">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/hapus_profil/<?php echo $row['id_profil']; ?>" data-toggle="tooltip" data-placement="top" title="HAPUS">
