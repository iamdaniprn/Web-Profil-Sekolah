	  	...
	  	<div class="col col-9 p1">
			  ...
			  <div class="p1" style="background: #e4e3e5;">
				  <div class="clearfix center">
				  	<div class="col col-4"><a href="<?php echo base_url() ?>user/kelas_1"><img class="fit" src="<?php echo base_url() ?>assets/icon/115-users.png" alt=""></a><bR>
				  	<h3>Kelas 10</h3>
				    </div>
				  	<div class="col col-4"><a href="<?php echo base_url() ?>user/kelas_2"><img class="fit" src="<?php echo base_url() ?>assets/icon/115-users.png" alt=""></a><bR>
				  	<h3>Kelas 11</h3>
				    </div>
				    <div class="col col-4"><a href="<?php echo base_url() ?>user/kelas_3"><img class="fit" src="<?php echo base_url() ?>assets/icon/115-users.png" alt=""></a><bR>
				  	<h3>Kelas 12</h3>
				    </div>
				  </div>
			  </div>
