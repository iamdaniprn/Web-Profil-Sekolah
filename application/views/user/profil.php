				...
				<div class="p1" style="background: #e4e3e5">
					...
					<div class="clearfix">
				   		...
				   		<div class="col col-9">
				   			...
				   			<p style="text-align: justify;"><?php echo substr($row->isi, 0,200) ?>... <b style="color: #03c129 ">[<a href="<?php echo base_url() ?>user/detail_profil/<?php echo $row->id_profil ?>" style="color: #03c129 ">Read More</a>]</b></p>
				   		</div>
				   		<hr>
				    </div>
				    <?php 
